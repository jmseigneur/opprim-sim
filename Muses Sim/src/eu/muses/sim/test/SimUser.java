...
public class SimUser extends User {
     ...
     * @return the asset
     */
    public Asset addsNewAssetToRt2ae(RealTimeRiskTrustAnalysisEngine rt2ae, Asset asset) {
     ...
     * @return true, if successful
     */
    public boolean authenticateWihMusesCredentials(String userLogin, String password) {
        // TODO Auto-generated method stub
        return true;
    }
     ...
     */
    public MusesServerApp configureMusesServerApp(RealTimeRiskTrustAnalysisEngine rt2ae) {
        // TODO Auto-generated method stub
     ...
     */
    public RealTimeRiskTrustAnalysisEngine configureRt2ae(EventProcessor eventProcessor, RiskPolicy riskPolicy) {
     ...
     * @return true, if successful
     */
    public boolean decidesToApplyAProposedRiskTreatment(AccessRequest accessRequest) {
        // TODO Auto-generated method stub
        return false;
    }
     ...
     * @return the access request
     */
    public AccessRequest requestsAccessToAssetsForOpportunity(Collection<Asset> assets, Opportunity opportunity,
