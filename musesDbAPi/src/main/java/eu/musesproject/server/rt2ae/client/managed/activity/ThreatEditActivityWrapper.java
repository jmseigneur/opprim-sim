...
public class ThreatEditActivityWrapper extends ThreatEditActivityWrapper_Roo_Gwt {

    private final EntityProxyId<ThreatProxy> proxyId;

    public ThreatEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<ThreatProxy> proxyId) {
    ...
    public Place getBackButtonPlace() {
        return (proxyId == null) ? new ProxyListPlace(ThreatProxy.class) : new ProxyPlace(proxyId, ProxyPlace.Operation.DETAILS);
    }
    ...
    public String getTitleText() {
        return (proxyId == null) ? "New Threat" : "Edit Threat";
    }
    ...
    public interface View<V extends eu.musesproject.server.rt2ae.client.managed.ui.ThreatEditView<V>> extends View_Roo_Gwt<V> {
    }
}
