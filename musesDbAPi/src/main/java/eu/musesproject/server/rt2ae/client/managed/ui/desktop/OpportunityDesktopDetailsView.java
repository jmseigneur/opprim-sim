...
public class OpportunityDesktopDetailsView extends OpportunityDesktopDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static OpportunityDesktopDetailsView instance;
    ...
    public OpportunityDesktopDetailsView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static OpportunityDesktopDetailsView instance() {
        if (instance == null) {
            instance = new OpportunityDesktopDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, OpportunityDesktopDetailsView> {
    }
}
