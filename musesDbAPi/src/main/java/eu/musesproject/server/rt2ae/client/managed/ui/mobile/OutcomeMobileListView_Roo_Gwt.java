...
public abstract class OutcomeMobileListView_Roo_Gwt extends MobileProxyListView<OutcomeProxy> {

    protected Set<String> paths = new HashSet<String>();

    public OutcomeMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<OutcomeProxy> renderer) {
