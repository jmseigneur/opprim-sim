...
public abstract class UserActionListActivity_Roo_Gwt extends AbstractProxyListActivity<UserActionProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public UserActionListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<UserActionProxy> view, Class<UserActionProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<Long> callback) {
        requests.userActionRequest().countUserActions().fire(callback);
    }
}
