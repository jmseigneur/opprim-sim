...
public class RiskcommunicationDesktopDetailsView extends RiskcommunicationDesktopDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static RiskcommunicationDesktopDetailsView instance;
    ...
    public RiskcommunicationDesktopDetailsView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static RiskcommunicationDesktopDetailsView instance() {
        if (instance == null) {
            instance = new RiskcommunicationDesktopDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, RiskcommunicationDesktopDetailsView> {
    }
}
