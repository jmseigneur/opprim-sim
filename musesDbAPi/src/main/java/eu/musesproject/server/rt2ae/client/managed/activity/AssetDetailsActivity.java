...
public class AssetDetailsActivity extends AssetDetailsActivity_Roo_Gwt {

    public AssetDetailsActivity(EntityProxyId<AssetProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, AssetDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(AssetProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((AssetProxy) proxy);
