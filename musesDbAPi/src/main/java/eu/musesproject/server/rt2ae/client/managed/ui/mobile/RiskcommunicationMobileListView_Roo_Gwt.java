...
public abstract class RiskcommunicationMobileListView_Roo_Gwt extends MobileProxyListView<RiskcommunicationProxy> {

    protected Set<String> paths = new HashSet<String>();

    public RiskcommunicationMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<RiskcommunicationProxy> renderer) {
