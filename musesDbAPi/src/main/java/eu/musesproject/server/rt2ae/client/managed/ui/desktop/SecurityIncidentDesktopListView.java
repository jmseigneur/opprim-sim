...
public class SecurityIncidentDesktopListView extends SecurityIncidentDesktopListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static SecurityIncidentDesktopListView instance;

    @UiField
    Button newButton;

    public SecurityIncidentDesktopListView() {
        init(BINDER.createAndBindUi(this), table, newButton);
        table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
        init();
    }

    public static SecurityIncidentDesktopListView instance() {
        if (instance == null) {
            instance = new SecurityIncidentDesktopListView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, SecurityIncidentDesktopListView> {
    }
}
