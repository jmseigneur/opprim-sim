...
public class SecurityIncidentEditActivityWrapper extends SecurityIncidentEditActivityWrapper_Roo_Gwt {

    private final EntityProxyId<SecurityIncidentProxy> proxyId;

    public SecurityIncidentEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<SecurityIncidentProxy> proxyId) {
    ...
    public Place getBackButtonPlace() {
        return (proxyId == null) ? new ProxyListPlace(SecurityIncidentProxy.class) : new ProxyPlace(proxyId, ProxyPlace.Operation.DETAILS);
    }
    ...
    public String getTitleText() {
        return (proxyId == null) ? "New SecurityIncident" : "Edit SecurityIncident";
    }
    ...
    public interface View<V extends eu.musesproject.server.rt2ae.client.managed.ui.SecurityIncidentEditView<V>> extends View_Roo_Gwt<V> {
    }
}
