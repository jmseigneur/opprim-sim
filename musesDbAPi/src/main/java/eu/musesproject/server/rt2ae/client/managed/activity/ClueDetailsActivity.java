...
public class ClueDetailsActivity extends ClueDetailsActivity_Roo_Gwt {

    public ClueDetailsActivity(EntityProxyId<ClueProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ClueDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(ClueProxy.class);
    }
