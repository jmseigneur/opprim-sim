...
public class AccessrequestDesktopEditView extends AccessrequestDesktopEditView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static AccessrequestDesktopEditView instance;
    ...
    public AccessrequestDesktopEditView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static AccessrequestDesktopEditView instance() {
        if (instance == null) {
            instance = new AccessrequestDesktopEditView();
        }
        //Jim
        return instance;
    }
    ...
    @Override
    public RequestFactoryEditorDriver<AccessrequestProxy, AccessrequestDesktopEditView> createEditorDriver() {
        RequestFactoryEditorDriver<AccessrequestProxy, AccessrequestDesktopEditView> driver = GWT.create(Driver.class);
    ...
    interface Binder extends UiBinder<HTMLPanel, AccessrequestDesktopEditView> {
    }

    interface Driver extends RequestFactoryEditorDriver<AccessrequestProxy, AccessrequestDesktopEditView> {
    }
}
