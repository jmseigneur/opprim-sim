...
public class RiskcommunicationDesktopListView extends RiskcommunicationDesktopListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static RiskcommunicationDesktopListView instance;

    @UiField
    Button newButton;

    public RiskcommunicationDesktopListView() {
        init(BINDER.createAndBindUi(this), table, newButton);
        table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
        init();
    }

    public static RiskcommunicationDesktopListView instance() {
        if (instance == null) {
            instance = new RiskcommunicationDesktopListView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, RiskcommunicationDesktopListView> {
    }
}
