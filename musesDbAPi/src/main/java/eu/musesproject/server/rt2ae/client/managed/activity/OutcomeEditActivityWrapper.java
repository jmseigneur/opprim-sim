...
public class OutcomeEditActivityWrapper extends OutcomeEditActivityWrapper_Roo_Gwt {

    private final EntityProxyId<OutcomeProxy> proxyId;

    public OutcomeEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<OutcomeProxy> proxyId) {
    ...
    public Place getBackButtonPlace() {
        return (proxyId == null) ? new ProxyListPlace(OutcomeProxy.class) : new ProxyPlace(proxyId, ProxyPlace.Operation.DETAILS);
    }
    ...
    public String getTitleText() {
        return (proxyId == null) ? "New Outcome" : "Edit Outcome";
    }
    ...
    public interface View<V extends eu.musesproject.server.rt2ae.client.managed.ui.OutcomeEditView<V>> extends View_Roo_Gwt<V> {
    }
}
