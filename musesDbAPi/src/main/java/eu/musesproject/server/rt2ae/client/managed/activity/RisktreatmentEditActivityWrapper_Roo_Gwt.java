...
public abstract class RisktreatmentEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends eu.musesproject.server.rt2ae.client.managed.ui.RisktreatmentEditView<V>> extends RisktreatmentEditView<V> {
