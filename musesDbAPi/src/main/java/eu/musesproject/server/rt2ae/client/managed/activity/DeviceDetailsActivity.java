...
public class DeviceDetailsActivity extends DeviceDetailsActivity_Roo_Gwt {
    ...
    public DeviceDetailsActivity(EntityProxyId<DeviceProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, DeviceDetailsView view) {
