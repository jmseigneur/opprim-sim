...
public class SecurityIncidentListActivity extends SecurityIncidentListActivity_Roo_Gwt {

    public SecurityIncidentListActivity(ApplicationRequestFactory requests, ProxyListView<SecurityIncidentProxy> view, PlaceController placeController) {
        super(placeController, view, SecurityIncidentProxy.class);
    ...
    protected Request<List<SecurityIncidentProxy>> createRangeRequest(Range range) {
        return requests.securityIncidentRequest().findSecurityIncidentEntries(range.getStart(), range.getLength());
    }
}
