...
public class AccessrequestDetailsActivity extends AccessrequestDetailsActivity_Roo_Gwt {

    public AccessrequestDetailsActivity(EntityProxyId<AccessrequestProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, AccessrequestDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(AccessrequestProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((AccessrequestProxy) proxy);
