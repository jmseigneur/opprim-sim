...
public abstract class RisktreatmentListActivity_Roo_Gwt extends AbstractProxyListActivity<RisktreatmentProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public RisktreatmentListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<RisktreatmentProxy> view, Class<RisktreatmentProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<Long> callback) {
        requests.risktreatmentRequest().countRisktreatments().fire(callback);
    }
}
