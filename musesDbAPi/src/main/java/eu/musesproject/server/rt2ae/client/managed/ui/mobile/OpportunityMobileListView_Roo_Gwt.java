...
public abstract class OpportunityMobileListView_Roo_Gwt extends MobileProxyListView<OpportunityProxy> {

    protected Set<String> paths = new HashSet<String>();

    public OpportunityMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<OpportunityProxy> renderer) {
