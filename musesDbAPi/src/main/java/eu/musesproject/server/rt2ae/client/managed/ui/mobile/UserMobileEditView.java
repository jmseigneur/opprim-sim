...
public class UserMobileEditView extends UserMobileEditView_Roo_Gwt {
    ...
    private static UserMobileEditView instance;
    ...
    public static UserMobileEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<UserProxy, UserMobileEditView> createEditorDriver() {
