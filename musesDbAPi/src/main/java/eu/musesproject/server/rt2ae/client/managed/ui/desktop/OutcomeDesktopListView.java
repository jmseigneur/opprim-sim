...
public class OutcomeDesktopListView extends OutcomeDesktopListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static OutcomeDesktopListView instance;

    @UiField
    Button newButton;

    public OutcomeDesktopListView() {
        init(BINDER.createAndBindUi(this), table, newButton);
        table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
        init();
    }

    public static OutcomeDesktopListView instance() {
        if (instance == null) {
            instance = new OutcomeDesktopListView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, OutcomeDesktopListView> {
    }
}
