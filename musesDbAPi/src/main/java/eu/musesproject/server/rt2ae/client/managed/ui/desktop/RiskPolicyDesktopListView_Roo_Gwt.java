...
public abstract class RiskPolicyDesktopListView_Roo_Gwt extends AbstractProxyListView<RiskPolicyProxy> {

    @UiField
    CellTable<RiskPolicyProxy> table;

    protected Set<String> paths = new HashSet<String>();

    public void init() {
        paths.add("riskpolicyId");
        table.addColumn(new TextColumn<RiskPolicyProxy>() {
            ...
            @Override
            public String getValue(RiskPolicyProxy object) {
                return renderer.render(object.getRiskpolicyId());
            }
        }, "Riskpolicy Id");
        paths.add("riskvalue");
        table.addColumn(new TextColumn<RiskPolicyProxy>() {
            ...
            @Override
            public String getValue(RiskPolicyProxy object) {
                return renderer.render(object.getRiskvalue());
            }
        }, "Riskvalue");
