...
public abstract class DeviceSecurityStateListActivity_Roo_Gwt extends AbstractProxyListActivity<DeviceSecurityStateProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public DeviceSecurityStateListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<DeviceSecurityStateProxy> view, Class<DeviceSecurityStateProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<Long> callback) {
        requests.deviceSecurityStateRequest().countDeviceSecurityStates().fire(callback);
    }
}
