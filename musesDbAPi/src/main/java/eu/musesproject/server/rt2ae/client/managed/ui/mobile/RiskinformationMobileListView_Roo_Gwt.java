...
public abstract class RiskinformationMobileListView_Roo_Gwt extends MobileProxyListView<RiskinformationProxy> {

    protected Set<String> paths = new HashSet<String>();

    public RiskinformationMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<RiskinformationProxy> renderer) {
