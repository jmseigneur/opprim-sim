...
public class DeviceDesktopEditView extends DeviceDesktopEditView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static DeviceDesktopEditView instance;
    ...
    public DeviceDesktopEditView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static DeviceDesktopEditView instance() {
        if (instance == null) {
            instance = new DeviceDesktopEditView();
        }
        //Jim
        return instance;
    }
    ...
    @Override
    public RequestFactoryEditorDriver<DeviceProxy, DeviceDesktopEditView> createEditorDriver() {
        RequestFactoryEditorDriver<DeviceProxy, DeviceDesktopEditView> driver = GWT.create(Driver.class);
    ...
    interface Binder extends UiBinder<HTMLPanel, DeviceDesktopEditView> {
    }

    interface Driver extends RequestFactoryEditorDriver<DeviceProxy, DeviceDesktopEditView> {
    }
}
