...
public class DecisionDesktopDetailsView extends DecisionDesktopDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static DecisionDesktopDetailsView instance;
    ...
    public DecisionDesktopDetailsView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static DecisionDesktopDetailsView instance() {
        if (instance == null) {
            instance = new DecisionDesktopDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, DecisionDesktopDetailsView> {
    }
}
