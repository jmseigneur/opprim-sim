...
public abstract class AccessrequestMobileListView_Roo_Gwt extends MobileProxyListView<AccessrequestProxy> {

    protected Set<String> paths = new HashSet<String>();

    public AccessrequestMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<AccessrequestProxy> renderer) {
