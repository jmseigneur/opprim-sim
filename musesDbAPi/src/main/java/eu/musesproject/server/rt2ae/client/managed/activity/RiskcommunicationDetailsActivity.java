...
public class RiskcommunicationDetailsActivity extends RiskcommunicationDetailsActivity_Roo_Gwt {

    public RiskcommunicationDetailsActivity(EntityProxyId<RiskcommunicationProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, RiskcommunicationDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(RiskcommunicationProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((RiskcommunicationProxy) proxy);
