...
public class DeviceMobileListView extends DeviceMobileListView_Roo_Gwt {
    ...
    private static DeviceMobileListView instance;
    ...
    public static DeviceMobileListView instance() {
        if (instance == null) {
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<DeviceProxy> {
        ...
        private final Renderer<DeviceProxy> primaryRenderer = eu.musesproject.server.rt2ae.client.managed.ui.renderer.DeviceProxyRenderer.instance();
        ...
        public SafeHtml render(DeviceProxy value) {
            ...
            if (value.getType() != null) {
                sb.appendEscaped(secondaryRenderer.render(value.getType()));
            }
