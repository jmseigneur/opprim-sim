...
public class AccessrequestDesktopListView extends AccessrequestDesktopListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static AccessrequestDesktopListView instance;

    @UiField
    Button newButton;

    public AccessrequestDesktopListView() {
        init(BINDER.createAndBindUi(this), table, newButton);
        table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
        init();
    }

    public static AccessrequestDesktopListView instance() {
        if (instance == null) {
            instance = new AccessrequestDesktopListView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, AccessrequestDesktopListView> {
    }
}
