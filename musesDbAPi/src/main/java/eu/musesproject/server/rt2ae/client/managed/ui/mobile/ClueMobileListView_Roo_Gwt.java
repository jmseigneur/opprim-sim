...
public abstract class ClueMobileListView_Roo_Gwt extends MobileProxyListView<ClueProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ClueMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<ClueProxy> renderer) {
