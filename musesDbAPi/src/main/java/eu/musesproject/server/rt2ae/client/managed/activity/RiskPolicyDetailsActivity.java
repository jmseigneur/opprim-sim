...
public class RiskPolicyDetailsActivity extends RiskPolicyDetailsActivity_Roo_Gwt {

    public RiskPolicyDetailsActivity(EntityProxyId<RiskPolicyProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, RiskPolicyDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(RiskPolicyProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((RiskPolicyProxy) proxy);
