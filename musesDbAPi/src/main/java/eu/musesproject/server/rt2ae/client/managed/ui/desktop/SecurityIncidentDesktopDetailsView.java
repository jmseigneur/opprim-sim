...
public class SecurityIncidentDesktopDetailsView extends SecurityIncidentDesktopDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static SecurityIncidentDesktopDetailsView instance;
    ...
    public SecurityIncidentDesktopDetailsView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static SecurityIncidentDesktopDetailsView instance() {
        if (instance == null) {
            instance = new SecurityIncidentDesktopDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, SecurityIncidentDesktopDetailsView> {
    }
}
