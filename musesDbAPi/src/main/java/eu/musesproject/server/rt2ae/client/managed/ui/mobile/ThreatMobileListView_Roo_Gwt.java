...
public abstract class ThreatMobileListView_Roo_Gwt extends MobileProxyListView<ThreatProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ThreatMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<ThreatProxy> renderer) {
