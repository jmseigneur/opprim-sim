...
import eu.musesproject.server.rt2ae.client.managed.ui.DecisionDetailsView.Delegate;
...
public abstract class DecisionDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<DecisionProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected DecisionDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.decisionRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
