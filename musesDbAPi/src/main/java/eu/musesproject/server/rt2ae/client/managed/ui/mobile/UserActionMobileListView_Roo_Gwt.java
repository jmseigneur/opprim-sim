...
public abstract class UserActionMobileListView_Roo_Gwt extends MobileProxyListView<UserActionProxy> {

    protected Set<String> paths = new HashSet<String>();

    public UserActionMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<UserActionProxy> renderer) {
