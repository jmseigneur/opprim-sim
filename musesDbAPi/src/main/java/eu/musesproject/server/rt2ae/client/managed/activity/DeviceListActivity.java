...
public class DeviceListActivity extends DeviceListActivity_Roo_Gwt {
    ...
    public DeviceListActivity(ApplicationRequestFactory requests, ProxyListView<DeviceProxy> view, PlaceController placeController) {
    ...
    protected Request<List<DeviceProxy>> createRangeRequest(Range range) {
