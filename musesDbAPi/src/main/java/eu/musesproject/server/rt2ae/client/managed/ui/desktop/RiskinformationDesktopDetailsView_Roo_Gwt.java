...
public abstract class RiskinformationDesktopDetailsView_Roo_Gwt extends Composite implements RiskinformationDetailsView {

    @UiField
    SpanElement riskinformationId;
    ...
    public void setValue(RiskinformationProxy proxy) {
        ...
        displayRenderer.setInnerText(eu.musesproject.server.rt2ae.client.managed.ui.renderer.RiskinformationProxyRenderer.instance().render(proxy));
    }
}
