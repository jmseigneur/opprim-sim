...
public abstract class RiskinformationListActivity_Roo_Gwt extends AbstractProxyListActivity<RiskinformationProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public RiskinformationListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<RiskinformationProxy> view, Class<RiskinformationProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<Long> callback) {
        requests.riskinformationRequest().countRiskinformations().fire(callback);
    }
}
