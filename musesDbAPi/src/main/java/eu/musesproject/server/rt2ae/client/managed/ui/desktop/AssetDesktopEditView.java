...
public class AssetDesktopEditView extends AssetDesktopEditView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static AssetDesktopEditView instance;
    ...
    public AssetDesktopEditView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static AssetDesktopEditView instance() {
        if (instance == null) {
            instance = new AssetDesktopEditView();
        }
        //Jim
        return instance;
    }
    ...
    @Override
    public RequestFactoryEditorDriver<AssetProxy, AssetDesktopEditView> createEditorDriver() {
        RequestFactoryEditorDriver<AssetProxy, AssetDesktopEditView> driver = GWT.create(Driver.class);
    ...
    interface Binder extends UiBinder<HTMLPanel, AssetDesktopEditView> {
    }

    interface Driver extends RequestFactoryEditorDriver<AssetProxy, AssetDesktopEditView> {
    }
}
