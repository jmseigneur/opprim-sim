...
public class SecurityIncidentDetailsActivity extends SecurityIncidentDetailsActivity_Roo_Gwt {

    public SecurityIncidentDetailsActivity(EntityProxyId<SecurityIncidentProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, SecurityIncidentDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(SecurityIncidentProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((SecurityIncidentProxy) proxy);
