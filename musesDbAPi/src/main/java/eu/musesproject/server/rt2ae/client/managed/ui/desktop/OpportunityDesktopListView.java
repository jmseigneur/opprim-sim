...
public class OpportunityDesktopListView extends OpportunityDesktopListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static OpportunityDesktopListView instance;

    @UiField
    Button newButton;

    public OpportunityDesktopListView() {
        init(BINDER.createAndBindUi(this), table, newButton);
        table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
        init();
    }

    public static OpportunityDesktopListView instance() {
        if (instance == null) {
            instance = new OpportunityDesktopListView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, OpportunityDesktopListView> {
    }
}
