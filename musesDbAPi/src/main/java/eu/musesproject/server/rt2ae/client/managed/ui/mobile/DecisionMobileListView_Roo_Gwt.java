...
public abstract class DecisionMobileListView_Roo_Gwt extends MobileProxyListView<DecisionProxy> {

    protected Set<String> paths = new HashSet<String>();

    public DecisionMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<DecisionProxy> renderer) {
