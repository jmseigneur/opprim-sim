package eu.musesproject.server.rt2ae.client.scaffold.place;
 ...
 * {@link eu.musesproject.server.rt2ae.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link eu.musesproject.server.rt2ae.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link eu.musesproject.server.rt2ae.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
