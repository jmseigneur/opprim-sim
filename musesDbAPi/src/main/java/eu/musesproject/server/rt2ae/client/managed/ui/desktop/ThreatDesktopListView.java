...
public class ThreatDesktopListView extends ThreatDesktopListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static ThreatDesktopListView instance;

    @UiField
    Button newButton;

    public ThreatDesktopListView() {
        init(BINDER.createAndBindUi(this), table, newButton);
        table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
        init();
    }

    public static ThreatDesktopListView instance() {
        if (instance == null) {
            instance = new ThreatDesktopListView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, ThreatDesktopListView> {
    }
}
