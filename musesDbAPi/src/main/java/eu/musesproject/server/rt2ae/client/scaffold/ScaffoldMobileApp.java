...
import eu.musesproject.server.rt2ae.client.managed.activity.*;
import eu.musesproject.server.rt2ae.client.managed.request.ApplicationRequestFactory;
import eu.musesproject.server.rt2ae.client.managed.ui.renderer.ApplicationListPlaceRenderer;
import eu.musesproject.server.rt2ae.client.scaffold.activity.IsScaffoldMobileActivity;
import eu.musesproject.server.rt2ae.client.scaffold.place.*;
import eu.musesproject.server.rt2ae.client.scaffold.gae.GaeHelper;
import eu.musesproject.server.rt2ae.client.style.MobileListResources;
