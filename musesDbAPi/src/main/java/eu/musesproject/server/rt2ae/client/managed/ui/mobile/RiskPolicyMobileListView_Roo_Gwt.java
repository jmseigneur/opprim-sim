...
public abstract class RiskPolicyMobileListView_Roo_Gwt extends MobileProxyListView<RiskPolicyProxy> {

    protected Set<String> paths = new HashSet<String>();

    public RiskPolicyMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<RiskPolicyProxy> renderer) {
