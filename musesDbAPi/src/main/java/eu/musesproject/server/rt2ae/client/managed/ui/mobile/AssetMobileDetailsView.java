...
public class AssetMobileDetailsView extends AssetMobileDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static AssetMobileDetailsView instance;
    ...
    public AssetMobileDetailsView() {
        initWidget(BINDER.createAndBindUi(this));
    }

    public static AssetMobileDetailsView instance() {
        if (instance == null) {
            instance = new AssetMobileDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, AssetMobileDetailsView> {
    }
}
